...
public final class ModSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource PSY_GRASS =
            SurfaceRules.state(ModBlocks.PSYCHEDELIC_GRASS_BLOCK.get().defaultBlockState());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource valleySurface =
                SurfaceRules.sequence(SurfaceRules.ifTrue(atOrAboveWater, PSY_GRASS), DIRT);

        SurfaceRules.RuleSource mushroomSurface =
                SurfaceRules.sequence(SurfaceRules.ifTrue(atOrAboveWater, PSY_MYCELIUM), DIRT);

        return SurfaceRules.sequence(
                SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.PSYCHEDELIC_VALLEY),
                        SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, valleySurface)),
