...
final class ChemicalReactorRecipeCategory extends AbstractNiceRecipeCategory<ChemicalReactorRecipe> {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, ChemicalReactorRecipe recipe, IFocusGroup focuses) {
        ...
        recipe.secondaryFluid().ifPresent(fluidReq ->
                addFluid(builder, RecipeIngredientRole.INPUT, ChemicalReactorLayout.SECONDARY_TANK_X, ChemicalReactorLayout.TRANSFER_SLOT_Y, JeiCompatUtil.idOf(fluidReq, "fluid", "fluidId"), JeiCompatUtil.intOf(fluidReq, "amount"))
        );
        ...
        if (!outputStack.isEmpty()) {
            addItemStack(builder, RecipeIngredientRole.OUTPUT, ChemicalReactorLayout.OUTPUT_TANK_X, ChemicalReactorLayout.TRANSFER_SLOT_Y, outputStack);
        } else if (outputFluid != Fluids.EMPTY) {
            addFluid(builder, RecipeIngredientRole.OUTPUT, ChemicalReactorLayout.OUTPUT_TANK_X, ChemicalReactorLayout.TRANSFER_SLOT_Y, outputFluid, recipe.outputAmount());
        } else {
