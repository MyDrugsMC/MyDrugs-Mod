...
public class CocaineDustItem extends DrugItem implements RollingIngredient {
    public CocaineDustItem(Properties properties, DrugId id, ConsumptionStrategy strategy) {
