...
public final class SieveLayout {
    ...
    public static final int GUI_HEIGHT = 148;
    ...
    public static final int PLAYER_INV_Y = 58;
    public static final int PLAYER_INV_W = 164;
    public static final int PLAYER_INV_H = 56;
    public static final int HOTBAR_X = 6;
    public static final int HOTBAR_Y = 120;
    public static final int HOTBAR_W = 164;
    public static final int HOTBAR_H = 20;
    private SieveLayout() {
    }
}