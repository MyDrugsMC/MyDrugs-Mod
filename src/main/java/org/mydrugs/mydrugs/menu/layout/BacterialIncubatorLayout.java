...
public final class BacterialIncubatorLayout {
    ...
    public static final int GENE_SLOT_X = 29;
    public static final int GENE_SLOT_Y = 39;
    public static final int NUTRIENT_SLOT_X = 29;
    public static final int NUTRIENT_SLOT_Y = 62;
    ...
    private BacterialIncubatorLayout() {
    }
}
