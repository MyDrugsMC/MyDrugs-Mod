...
public final class BTXFractionationTowerLayout {
    ...
    public static final int MACHINE_PANEL_W = 216;
    ...
    private static final int OUTPUT_GROUP_W = LayoutMath.groupWidth(StandardTankLayout.TANK_W, 3, TANK_GAP);
    ...
    public static final int BENZENE_TANK_X = LayoutMath.groupItemX(OUTPUT_GROUP_X, StandardTankLayout.TANK_W, TANK_GAP, 0);
    public static final int BENZENE_TANK_Y = INPUT_TANK_Y;

    public static final int TOLUENE_TANK_X = LayoutMath.groupItemX(OUTPUT_GROUP_X, StandardTankLayout.TANK_W, TANK_GAP, 1);
    public static final int TOLUENE_TANK_Y = INPUT_TANK_Y;

    public static final int XYLENE_TANK_X = LayoutMath.groupItemX(OUTPUT_GROUP_X, StandardTankLayout.TANK_W, TANK_GAP, 2);
    ...
    public static final int DUMP_BENZENE_X = LayoutMath.dumpButtonX(BENZENE_TANK_X, TANK_W, DUMP_BUTTON_SIZE);
    public static final int DUMP_TOLUENE_X = LayoutMath.dumpButtonX(TOLUENE_TANK_X, TANK_W, DUMP_BUTTON_SIZE);
    public static final int DUMP_XYLENE_X = LayoutMath.dumpButtonX(XYLENE_TANK_X, TANK_W, DUMP_BUTTON_SIZE);

    public static final int PROGRESS_W = 64;
    public static final int PROGRESS_H = 6;
    public static final int PROGRESS_X = LayoutMath.centeredBetween(INPUT_TANK_X + TANK_W, BENZENE_TANK_X, PROGRESS_W);
    ...
    public static final int CENTER_PANEL_X = LayoutMath.centeredBetween(INPUT_TANK_X + TANK_W, BENZENE_TANK_X, CENTER_PANEL_W);
    ...
    public static final int BENZENE_SLOT_X = BENZENE_TANK_X;
    public static final int BENZENE_SLOT_Y = INPUT_SLOT_Y;

    public static final int TOLUENE_SLOT_X = TOLUENE_TANK_X;
    public static final int TOLUENE_SLOT_Y = INPUT_SLOT_Y;

    public static final int XYLENE_SLOT_X = XYLENE_TANK_X;
