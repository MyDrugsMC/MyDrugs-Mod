...
public final class AromaticExtractorLayout {
    ...
    private static final int INPUT_GROUP_X = MACHINE_PANEL_X + SIDE_GUTTER;
    ...
    public static final int INPUT_TANK_X = INPUT_GROUP_X;
    public static final int INPUT_TANK_Y = MACHINE_PANEL_Y + 16;

    public static final int CATALYST_TANK_X = INPUT_TANK_X + StandardTankLayout.TANK_W + TANK_GAP;
    ...
    public static final int DUMP_CATALYST_X = LayoutMath.dumpButtonX(CATALYST_TANK_X, TANK_W, DUMP_BUTTON_SIZE);
    ...
    public static final int PROGRESS_X = LayoutMath.centeredBetween(CATALYST_TANK_X + TANK_W, OUTPUT_A_TANK_X, PROGRESS_W);
    ...
    public static final int CENTER_PANEL_X = LayoutMath.centeredBetween(CATALYST_TANK_X + TANK_W, OUTPUT_A_TANK_X, CENTER_PANEL_W);
    ...
    public static final int CATALYST_SLOT_X = CATALYST_TANK_X;
