...
public final class FluidFiltererLayout {
    ...
    public static final int OUTPUT_A_TANK_Y = 25;

    public static final int OUTPUT_B_TANK_X = 166;
    public static final int OUTPUT_B_TANK_Y = 25;
    ...
    public static final int INPUT_SLOT_Y = 83;

    public static final int OUTPUT_A_SLOT_X = 142;
    public static final int OUTPUT_A_SLOT_Y = 83;

    public static final int OUTPUT_B_SLOT_X = 166;
    public static final int OUTPUT_B_SLOT_Y = 83;

    public static final int FILTER_SLOT_X = 78;
    public static final int FILTER_SLOT_Y = 79;

    public static final int RESIDUE_SLOT_X = 102;
    public static final int RESIDUE_SLOT_Y = 79;
