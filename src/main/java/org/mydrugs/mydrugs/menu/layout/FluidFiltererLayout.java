...
public final class FluidFiltererLayout {
    ...
    public static final int OUTPUT_A_TANK_X = MACHINE_PANEL_X + MACHINE_PANEL_W - SIDE_GUTTER - TANK_W;
    public static final int OUTPUT_A_TANK_Y = INPUT_TANK_Y;

    public static final int OUTPUT_B_TANK_X = OUTPUT_A_TANK_X;
    public static final int OUTPUT_B_TANK_Y = OUTPUT_A_TANK_Y;
    ...
    public static final int DUMP_OUTPUT_B_X = DUMP_OUTPUT_A_X;

    public static final int RUN_BUTTON_W = 52;
    public static final int RUN_BUTTON_H = 20;
    public static final int RUN_BUTTON_X = LayoutMath.centeredBetween(INPUT_TANK_X + TANK_W, OUTPUT_A_TANK_X, RUN_BUTTON_W);
    public static final int RUN_BUTTON_Y = MACHINE_PANEL_Y + 20;
    ...
    public static final int PROGRESS_Y = RUN_BUTTON_Y + RUN_BUTTON_H + 8;
    ...
    public static final int OUTPUT_B_SLOT_X = OUTPUT_A_SLOT_X;
    public static final int OUTPUT_B_SLOT_Y = OUTPUT_A_SLOT_Y;

    private static final int CENTER_SLOT_GROUP_W = LayoutMath.groupWidth(StandardInventoryLayout.SLOT_SIZE, 2, 8);
    private static final int CENTER_SLOT_GROUP_X = LayoutMath.centeredBetween(INPUT_TANK_X + TANK_W, OUTPUT_A_TANK_X, CENTER_SLOT_GROUP_W);

    public static final int FILTER_SLOT_X = LayoutMath.groupItemX(CENTER_SLOT_GROUP_X, StandardInventoryLayout.SLOT_SIZE, 8, 0);
    public static final int FILTER_SLOT_Y = INPUT_SLOT_Y;

    public static final int RESIDUE_SLOT_X = LayoutMath.groupItemX(CENTER_SLOT_GROUP_X, StandardInventoryLayout.SLOT_SIZE, 8, 1);
    public static final int RESIDUE_SLOT_Y = INPUT_SLOT_Y;
