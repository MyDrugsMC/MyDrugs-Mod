...
public final class DrugRegistry {
    ...
    public static void registerDrugs() {
        ...
        addDrug(new DrugModel.Builder()
                ...
                .addEffect(new DrugEffect(EffectType.MINING_SPEED, TOBACCO_MAIN_DURATION, 0.24F))
        ...
        addDrug(new DrugModel.Builder()
                ...
                .addEffect(new DrugEffect(EffectType.MINING_SPEED, COFFEE_MAIN_DURATION, 0.15F))
                .addEffect(new DrugEffect(EffectType.LOW_LIGHT_VISION, COFFEE_MAIN_DURATION, 0.18F))
