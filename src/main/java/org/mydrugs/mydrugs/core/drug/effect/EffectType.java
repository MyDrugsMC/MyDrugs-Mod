...
public enum EffectType {
    ...
    PRECISION(EffectCategory.STAT_MODIFIER),
    TREMOR_REDUCTION(EffectCategory.STAT_MODIFIER),
    RITUAL_FOCUS(EffectCategory.STAT_MODIFIER),
    RITUAL_STABILITY(EffectCategory.STAT_MODIFIER),
    MOB_DETECTION_REDUCTION(EffectCategory.STAT_MODIFIER),
    ADRENALINE_SURGE(EffectCategory.STAT_MODIFIER),
